...
class PostController extends Controller
{
        ...
        $this->validate($request, [
            ...
            'project_type'                  =>'required',
                ...
                if ($request->hasFile('photo')) {
                    ...
                    $image->save(storage_path('app/public/post/featured/' . $file_name));
                }
    ...
    public function edit($id)
    {
        ...
        $edit_id= Post::findOrFail($id);
        $post_data= Post::latest()->get();
        $categorypost_data= Categorypost::latest()->get();
        $tagpost_data= Tagpost::latest()->get();
        $form_type= 'edit';
        return view('admin.pages.post.index', compact('post_data', 'categorypost_data', 'tagpost_data', 'form_type', 'edit_id'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('post.index')->with('success-mid', 'successfully update the data');
    }
    ...
    public function destroy($id)
    {
        ...
        $id=json_decode($delete_id->featured_image);
        
        if ($id->photo) {
            unlink(storage_path('app/public/post/featured/' . $id->photo));
        }
