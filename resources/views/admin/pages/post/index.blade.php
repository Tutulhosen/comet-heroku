                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td style="display: flex;">
                                            <a style="margin-right: 2px" class="btn btn-warning" href="{{route('post.edit', $post->id)}}"><i class="fa fa-edit"></i></a>
            ...
            <div class="col-lg-4">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{route('post.update', $edit_id->id)}}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            @php
                                $project_type= json_decode($edit_id->featured_image);
                            ...
                            <div class="form-group">
                                <label> Project Type </label><br>
                                <select class="form-control" name="project_type" id="project_type_option">
                                    <option @if ($project_type->project_type=="Standert")
                                        selected
                                    @endif value="Standert">Standert</option>
                                    <option @if ($project_type->project_type=="Gallery")
                                        selected
                                    @endif value="Gallery">Gallery</option>
                                    <option @if ($project_type->project_type=="Video")
                                        selected
                                    @endif value="Video">Video</option>
                                    <option @if ($project_type->project_type=="Audio")
                                        selected
                                    @endif value="Audio">Audio</option>
                                    <option @if ($project_type->project_type=="Quote")
                                        selected
                                    @endif value="Quote">Quote</option>
                                </select>
                            </div>
                            ...
                            <div class="form-group post_photo">
                                ...
                                <img style="max-width: 100%" id="slider-photo-preview" @if ($project_type->photo)
                                src="{{url('storage/post/featured/' . $project_type->photo)}}"
                                @endif  alt="">
                                <br><br>
                                <input style="display: none" name="photo" type="file" class="form-control" id="photo-icon">
                                <label for="photo-icon">
                            ...
                            <div class="form-group post_gallery">
                                ...
                                <div class="gallery">
                                    @foreach (json_decode($project_type->gallery) as $gall)
                                        <img src="{{url('storage/post/gallery/' . $gall)}}" alt="">
                                    @endforeach
                                </div>
                                <br><br>
                                <input style="display: none" name="gallery[]" multiple type="file" class="form-control" id="gallery_image">
                            ...
                            <div class="form-group post_video">
                                <label> Video </label>
                                <input name="video" type="text" class="form-control" @if ($project_type->video)
                            ...
                            <div class="form-group post_audio">
                                <label> Audio </label>
                                <input name="audio" type="text" class="form-control" @if ($project_type->audio)
                                value="{{$project_type->audio}}"
                                @endif>>
                            </div>
