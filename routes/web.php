 ...
 */
  ...
  */
  ...
  Route::get('/blog', [FrontendController::class, 'blogpageshow'])->name('blog.page.index');
  Route::get('/blog-single-page/{slug}', [FrontendController::class, 'blogsinglepageshow'])->name('blog.single.page.index');
  Route::get('/blog-category/{slug}', [FrontendController::class, 'blogpostbycategory'])->name('blog.post.category');
  Route::get('/blog-tag/{slug}', [FrontendController::class, 'blogpostbytag'])->name('blog.post.tag');
  Route::get('/blog-scr/{slug}', [FrontendController::class, 'blogpostbysrc'])->name('blog.post.src');
